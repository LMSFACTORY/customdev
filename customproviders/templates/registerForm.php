...
">
                    ...
                    <div class="date_container col-md-6">
                        ...
                        <div class="date_container_body row justify-content-start align-items-center">
                            ...
                            <input type="date" class="form-control dateInput" placeholder="mm/dd/yyyy"
                                ...
                                value="<?php echo $err_data['date_validite_document'] ?>" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="alert alert-info mt-3">
        <p><b>Note :</b> La création du compte peut prendre jusqu'à 5 min. À la fin du process, un courriel sera envoyé
    ...
    <a class="btn btn-secondary" href="/customdev/customproviders/index.php">Annuler</a>
</form>