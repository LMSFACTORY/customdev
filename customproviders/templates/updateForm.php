...
<form action="update_provider.php?email=<?php echo $email ?>" method="post">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="siret"
                        ...
                        value="<?php echo $err_data['nom_etab'] ?? $err_data['siret'] ?>">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control <?php echo (!empty($err_data['function_err'])) ? 'is-invalid' :
                        ...
                        <option value="<?php echo $value; ?>"
                            <?php echo ($value == $err_data['function'] || $value == $err_data['fonction']) ? 'selected' : ''; ?>>
                            <?php echo $value; ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
        ...
        <div class="section_body" id="domainInterventionCollapse">
            ...
            <div class="form-row">
                <div class="date_container col-md-6">
                    ...
                    <div class="date_container_body row justify-content-start align-items-center">
                        <label class="container__input">
                            <input class="form-check-input enableDateCheckbox" name="check_date_prediagnostic"
                                type="checkbox" <?php
                ...
                <div class="date_container col-md-6">
                    ...
                    <div class="date_container_body row justify-content-start align-items-center">
                        <label class="container__input">
                            <input class="form-check-input enableDateCheckbox" name="check_date_formation_inpi"
                                type="checkbox" <?php
            ...
            <div class="form-row">
                <div class="date_container col-md-6">
                    ...
                    <div class="date_container_body row justify-content-start align-items-center">
                        <label class="container__input">
                            <input class="form-check-input enableDateCheckbox" name="check_date_formation_outils"
                                type="checkbox" <?php
                ...
                <div class="date_container col-md-6">
                    ...
                    <div class="date_container_body row justify-content-start align-items-center">
                        <label class="container__input">
                            <input class="form-check-input enableDateCheckbox" name="check_date_formation_observateur"
                                type="checkbox" <?php
            ...
            <div class="form-row align-items-end">
                <div class="date_container col-md-6">
                    ...
                    <div class="date_container_body row justify-content-start align-items-center">
                        <label class="container__input">
                            <input class="form-check-input enableDateCheckbox" name="check_date_audit_pedagogique"
                                id="audit_pedagogic" type="checkbox" <?php
                ...
                <div class="form-group col-md-6 mb-0">
                    <label for="session_concern">Session concernées</label>
                    <input type="text" name="session_concern"
                        class="form-control <?php echo (!empty($err_data['session_concern_err'])) ? 'is-invalid' : ''; ?>"
                        id="session_concern" aria-describedby="session_concernHelp" placeholder="Ex : 1, 2, 3"
                        value="<?php echo $err_data['session_concern'] ?>" disabled>
    ...
    <section class="section domain_excellence">
        ...
        <div class="section_body" id="domainExcellenceCollapse">
            <div class="tag-container">
                ...
                <input type="hidden" name="domain_excellence" id="selectedDomains" value="
                       <?php echo $err_data['domain_excellence']; ?>
">
                <?php
...
">
        ...
        <div class="section_body" id="zoneGestionCollapse">
            <div class="zone-container">
                <div class="form-row align-items-end">
                    ...
                    <div class="date_container col-md-6">
                        <div class="date_container_header">
                            <p>Date de validité des documents renouvelables</p>
                        </div>
                        <div class="date_container_body row justify-content-start align-items-center">
                            <label class="container__input">
                                <input class="form-check-input enableDateCheckbox" name="check_date_validite_document"
                                    id="audit_pedagogic" type="checkbox" <?php
                                        echo ($err_data['date_validite_document']) ? 'checked' : '';
                                        ?> />
                                <span class="checkmark"></span>
                            </label>
                            <input type="date" class="form-control dateInput" placeholder="dd/mm/yyyy"
                                    name="date_validite_document" disabled
                                    value="<?php echo (!empty($err_data['date_validite_document'])) ? date('Y-m-d', strtotime($err_data['date_validite_document'])) : ''; ?>" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <button type="submit" class="btn btn-primary mt-3" name="update_provider">Valider les informations</button>
</form>